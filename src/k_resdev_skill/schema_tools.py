...
SCHEMA_ALIASES = {
    ...
    "admin-reviewed-seed-drift": "admin_reviewed_seed_drift_dashboard.schema.json",
    "admin_reviewed_seed_drift": "admin_reviewed_seed_drift_dashboard.schema.json",
    "admin-reviewed-seed-drift-dashboard": "admin_reviewed_seed_drift_dashboard.schema.json",
    "admin_reviewed_seed_drift_dashboard": "admin_reviewed_seed_drift_dashboard.schema.json",
    "admin-reviewed-seed-drift-item": "admin_reviewed_seed_drift_item.schema.json",
    "admin_reviewed_seed_drift_item": "admin_reviewed_seed_drift_item.schema.json",
