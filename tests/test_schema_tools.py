...
def test_validate_json_file_accepts_admin_operating_layer_aliases():
    aliases = [
        ...
        ("templates/admin-profile-pack-review-record.json", "admin-profile-pack-review-record"),
        ("templates/admin-profile-pack-review-finding.json", "admin-profile-pack-review-finding"),
        ("templates/admin-profile-pack-review-summary.json", "admin-profile-pack-review-summary"),
