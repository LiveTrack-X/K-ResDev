...
Status: Beta 59 adds the Korean-first agent skill boundary and onboarding layer. `SKILL.md`, `README.md`, `guides/user-guide.md`, `guides/operations-guide.md`, `guides/agent-skill-boundary.md`, `guides/verification-core.md`, and `agents/openai.yaml` now present K-ResDev as a GPT/Codex skill first and a verification core second. Future implementation should start from this operating surface before adding more standalone CLI reports.
